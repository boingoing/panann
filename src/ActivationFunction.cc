...
double ActivationFunction::ExecuteLinear(double value) { return value; }
...
double ActivationFunction::ExecuteDerivativeGaussian(double value,
                                                     double field) {
...
double ActivationFunction::ExecuteDerivativeGaussianSymmetric(double value,
                                                              double field) {
