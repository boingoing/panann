...
void Perceptron::ComputeNeuronValueRange(size_t neuron_start_index, size_t neuron_count) {
...
ActivationFunctionType Perceptron::GetHiddenNeuronActivationFunctionType() const {
...
ActivationFunctionType Perceptron::GetOutputNeuronActivationFunctionType() const {
...
bool Perceptron::IsConstructed() const {
...
bool Perceptron::AreWeightsAllocated() const {
    return is_allocated_;
}

RandomWrapper& Perceptron::GetRandom() {
    return random_;
}
